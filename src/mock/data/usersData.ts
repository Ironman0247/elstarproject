...
export const userDetailData = [
    {
        ...
        status: 'active',
        personalInfo: {
            location: 'WW85+C3P, Ulaanbaatar',
            title: 'Үсчингийн 1р зэрэг',
            birthday: '10/10/2002',
    ...
    },
    {
        id: '2',
        name: 'Gantumur',
        email: 'Gantumur@sisi.num.edu.mn',
        phoneNumb: '99121161',
        img: '/img/avatars/thumb-2.jpg',
        role: 'User',
        ...
        status: 'active',
        personalInfo: {
            location: 'Peace Avenue, Chingeltei district, 3rd khoroo, Ulaanbaatar 15172',
            title: 'Мэргэжлийн үсчин',
            birthday: '03/02/1984',
            phoneNumber: '99121161',
            facebook: 'facebook.com/sample',
            twitter: 'twitter.com/sample',
            pinterest: 'pinterest.com/sample',
            linkedIn: 'linkedin/sample',
